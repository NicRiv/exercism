...
def preparation_time_in_minutes(number_of_layers):
    """
    Return the time that will be baking for each layer
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    This function takes two numbers representing the number
    of layers & the time already spent baking and calculates the total
